...
# ✅ 2. 读取题目数据
with open("20250716/stem_bigpoint.json", "r", encoding="utf-8") as f:
...
# ✅ 5. 保存结果到 JSON 文件
with open("knowledge_keywords_by_id.json", "w", encoding="utf-8") as f:
    json.dump(output, f, ensure_ascii=False, indent=2)

print("✅ 已完成关键词提取，并保存到 knowledge_keywords_by_id.json")